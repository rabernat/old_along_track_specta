...
\begin{figure*}[t!]
  ...
  \caption{Meridional heat transport per degree of longitude (upper left), mean meridional SST gradient (upper right), eddy kinetic energy (bottom left), and eddy diffusivity (bottom right) from the satellite data (solid) and POP model (dashed).}
  \label{fig:H}
\end{figure*}
...
R. Abernathey gratefully acknowledges support by NASA ROSES grant no.~NNX14AI46G.
\end{acknowledgment} 
